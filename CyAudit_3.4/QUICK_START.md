...
Copy-Item -Path "CyAudit_3.4" -Destination "C:\CyAudit\" -Recurse
...
Edit `C:\CyAudit\CyAudit_3.4\CyAuditPipeline.config.json`:
...
```powershell
$Action = New-ScheduledTaskAction -Execute "powershell.exe" -Argument '-ExecutionPolicy Bypass -NoProfile -File "C:\CyAudit\CyAudit_3.4\Run-CyAuditPipeline.ps1"' -WorkingDirectory "C:\CyAudit\CyAudit_3.4"
...
5. **Actions:** Start `powershell.exe` with arguments:
   ...
   ```
6. **Start in:** `C:\CyAudit\CyAudit_3.4`
